    ...
    <PageChrome currentTool="timesheet" onToggleTheme={toggleDarkMode} isDarkMode={isDarkMode}>
      ...
      <header className="mb-6 sm:mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Work Hours Calculator</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Total your shifts for the pay period — breaks and overnight included</p>
          </div>
        </div>
      </header>
