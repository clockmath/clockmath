...
export default function TimezoneConvertersHubPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800/20">
      ...
      <main className="relative max-w-6xl mx-auto px-4 py-6 sm:py-10">
        ...
        {/* Introduction */}
        <div className="bg-card dark:bg-slate-800 rounded-2xl p-5 sm:p-6 mb-8 shadow-sm border border-border/50 dark:border-slate-700/50">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
          {TIMEZONE_GUIDES.map((guide) => (
            <Link
              key={guide.href}
              href={guide.href}
              className={`group block p-5 sm:p-6 bg-gradient-to-br ${CATEGORY_COLORS[guide.category as keyof typeof CATEGORY_COLORS]} rounded-2xl border hover:shadow-sm transition-all duration-300`}
            >
        ...
        {/* Quick Tips Section */}
        <div className="bg-card dark:bg-slate-800 rounded-2xl p-5 sm:p-6 shadow-sm border border-border/50 dark:border-slate-700/50 mb-8">
